...
export default function CookieSettingsTrigger() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 left-6 z-[9998] p-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-white/60 hover:text-white hover:bg-white/20 transition-all shadow-lg group"
