		...
		<section className="min-h-[calc(100vh-80px)] grid grid-cols-1 lg:grid-cols-2 gap-16 px-6 py-24 max-w-[1400px] mx-auto items-center">
			<div className="animate-fade-in-up">
				...
				<h1 className="text-4xl lg:text-6xl font-black mb-6 leading-tight text-[#0f172a]">
					Verify your company.
					<br />
					<span className="text-[#10b981]">Prove your compliance.</span>
					<br />
					Win more contracts.
				</h1>

				<p className="text-xl text-[#64748b] mb-8 max-w-xl leading-relaxed">
					Booppa helps vendors become trusted and procurement-ready through
				...
				<div className="flex flex-wrap gap-x-6 gap-y-2 mb-10 text-sm text-[#64748b]">
					...
					<span className="flex items-center gap-1.5">
						<span className="font-bold text-[#0f172a]">1,000+</span> live
						tenders tracked
					</span>
					<span className="text-[#e2e8f0]">|</span>
					<span className="flex items-center gap-1.5">
						<span className="font-bold text-[#0f172a]">SGD 0</span> to get
						started
					</span>
				</div>
				...
				<div className="flex flex-wrap gap-6">
					{[
						...
						{
							step: "3",
							label: "Win more contracts",
							sub: "Procurement-ready evidence",
						},
					].map(({ step, label, sub }) => (
				...
				<div className="bg-white border border-[#e2e8f0] rounded-2xl p-8 shadow-2xl transition-all duration-300 hover:-translate-y-1">
					...
					<div className="flex flex-col gap-5">
						...
						<div className="space-y-2">
							{[
								...
								>
									...
									<span
										className={
											done ? "text-[#10b981] font-bold" : "text-[#cbd5e1]"
										}
									>
										{done ? "✓" : "○"}
									</span>
						...
						<div className="bg-[#f8fafc] p-4 rounded-lg border border-dashed border-[#cbd5e1]">
							<code className="text-xs text-[#94a3b8] break-all">
								0x7f9fade1c0d57a7af66ab4ead79fade1c0d57a7
							</code>
						</div>
