...
export default function PDPAPage() {
	...
	const [hasPdpaSubscription, setHasPdpaSubscription] = useState(false);
			...
			<section className="py-24 px-6">
				<div className="max-w-[900px] mx-auto">
					<div className="text-center mb-16">
						<h1 className="text-4xl lg:text-5xl font-black mb-6 text-[#0f172a]">
							PDPA Evidence Scan
						</h1>
						<p className="text-xl text-[#64748b] max-w-2xl mx-auto leading-relaxed">
							Automated technical assessment of PDPA compliance indicators. Not
							regulatory certification — operational evidence generation.
						</p>
					</div>
					...
					<div className="bg-[#f8fafc] p-12 rounded-3xl mb-12 border border-[#e2e8f0]">
						<h2 className="text-2xl font-bold mb-10 text-[#0f172a]">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
							{[
								{
									n: 1,
									t: "Section 11: Openness Obligation",
									d: "Checks for published privacy policy and data protection documentation",
								},
								{
									n: 2,
									t: "Section 13: Consent Obligation",
									d: "Analyzes cookie consent mechanisms and data collection forms",
								},
								{
									n: 3,
								...
								{
									n: 4,
									t: "Section 21: Access & Correction Rights",
									d: "Looks for DSAR (Data Subject Access Request) procedures",
								},
								{
									n: 5,
									t: "Section 24: Protection Obligation",
									d: "Tests for HTTPS, security headers, encryption indicators",
								},
								{
									n: 6,
									t: "DPO Requirements",
									d: "Searches for Data Protection Officer contact information",
								},
								{
									n: 7,
								...
								{
									n: 8,
									t: "Do Not Call (DNC) Registry",
									d: "Checks for DNC registry references for marketing communications",
								},
							].map((item) => (
								<div key={item.n} className="flex gap-4">
									<div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-[#10b981] to-[#059669] rounded-full flex items-center justify-center text-white font-bold">
										{item.n}
									</div>
									<div>
					...
					<div className="bg-white p-8 lg:p-12 rounded-3xl border-2 border-[#dc2626] shadow-sm">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-8">
							<div>
								<h4 className="font-bold text-[#059669] mb-4 text-lg">
									✓ What This Is
								</h4>
								<ul className="space-y-3">
									<li className="flex items-center gap-3 text-sm text-[#64748b]">
										<span className="text-[#10b981] font-bold">✓</span>{" "}
										Technical website scanning tool
									</li>
									<li className="flex items-center gap-3 text-sm text-[#64748b]">
										<span className="text-[#10b981] font-bold">✓</span> Evidence
							...
							<div>
								<h4 className="font-bold text-[#dc2626] mb-4 text-lg">
									✗ What This Is NOT
								</h4>
								<ul className="space-y-3">
									<li className="flex items-center gap-3 text-sm text-[#64748b]">
									...
									<li className="flex items-center gap-3 text-sm text-[#64748b]">
										<span className="text-[#dc2626] font-bold">✕</span>{" "}
										Substitute for qualified counsel
									</li>
								</ul>
							</div>
						</div>
						...
						<p className="bg-[#f8fafc] p-6 rounded-xl text-sm text-[#64748b] leading-relaxed">
							Your organization remains responsible for PDPA compliance. This
							scan provides technical evidence and documentation to support your
							compliance efforts. For regulatory guidance, consult PDPC Helpline
							(+65 6377 3131) or legal counsel.
						</p>
					</div>
				</div>
			</section>
