      ...
      <main className="bg-white min-h-screen py-16 px-6">
        <div className="container max-w-3xl mx-auto">
          ...
          <p className="text-[#64748b] text-lg mb-6">
            Your 7-document PDPA governance pack, PDPA Snapshot, and RFP Complete Kit are running now. Once they finish, your 9-section regulator-ready Cover Sheet PDF will be emailed to you automatically.
          </p>
