...
function CheckItem({ text, color = 'text-blue-500' }: { text: string; color?: string }) {
  return (
    ...
    <main className="bg-white min-h-screen overflow-x-hidden">
      ...
      <section className="py-24 px-6 bg-[#0f172a] text-white">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <h1 className="text-4xl lg:text-6xl font-black mb-6 leading-tight">
            ...
            <span className="text-blue-400">Evaluate faster.</span><br />
            Award confidently.
          </h1>
          <p className="text-xl text-white/70 mb-6 max-w-2xl mx-auto leading-relaxed">
            Stop chasing vendors for compliance documents. BOOPPA gives your team instant access to blockchain-verified vendor evidence &mdash; so you can shortlist confidently and award faster.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-[1100px] mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-[#64748b] max-w-2xl mx-auto">Transparent pricing for procurement teams. No hidden fees.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-[#e2e8f0] shadow-sm hover:-translate-y-1 transition-all flex flex-col">
              <h3 className="text-xl font-bold mb-3 text-[#0f172a]">Enterprise</h3>
              <div className="text-4xl font-black text-[#0f172a] mb-1">SGD 499<span className="text-lg text-[#64748b] font-normal">/mo</span></div>
              <p className="text-sm text-[#64748b] mb-6">For procurement teams evaluating vendors</p>
              ...
              <p className="text-xs text-[#94a3b8] mb-6 border-t border-[#e2e8f0] pt-4">For institutional procurement teams, GLCs, statutory boards</p>
            ...
            <div className="bg-[#0f172a] p-8 rounded-[2rem] border-2 border-blue-500 shadow-2xl hover:-translate-y-1 transition-all relative flex flex-col">
              ...
              <h3 className="text-xl font-bold mb-3 text-white">Enterprise Pro</h3>
              <div className="text-4xl font-black text-blue-400 mb-1">SGD 1,499<span className="text-lg text-white/60 font-normal">/mo</span></div>
              ...
              <p className="text-xs text-white/40 mb-6 border-t border-white/10 pt-4">For MNCs and government-linked companies</p>
      ...
      <section className="py-20 px-6 bg-[#f8fafc]">
        <div className="max-w-[1100px] mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl lg:text-3xl font-black text-[#0f172a] mb-2">Free Procurement Tools</h2>
            <p className="text-[#64748b]">Available to all procurement teams at no cost</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white p-8 rounded-2xl border border-[#e2e8f0] hover:border-blue-400 hover:shadow-lg transition-all">
                ...
                <Link href={t.href} className="text-blue-600 font-bold text-sm hover:underline">{t.cta}</Link>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-[#0f172a] text-white text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-white/70 text-xl mb-10">Start browsing and verifying vendors now &mdash; free tools included.</p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/vendors" className="inline-block px-10 py-5 bg-blue-600 hover:bg-blue-500 text-white font-black text-xl rounded-2xl transition-colors shadow-lg">
              Browse Vendor Network
            </Link>
            <Link href="/demo" className="inline-block px-10 py-5 border border-white/30 hover:border-white/60 text-white font-black text-xl rounded-2xl transition-colors">
              Book a Demo
            </Link>
          </div>
        </div>
