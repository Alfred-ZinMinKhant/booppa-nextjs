...
const tools = [
  ...
  { title: 'PDPA Quick Scan', desc: 'Run a 5-minute PDPA compliance check on your website.', href: '/pdpa/quick-scan', cta: 'Start Scan →' },
      ...
      <section className="py-20 px-6 bg-white border-b border-[#e2e8f0]">
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { tag: 'Compliance', title: 'How Singapore Courts Are Accepting Blockchain Evidence in 2025', date: 'Jan 2025', href: '/blog/singapore-courts-blockchain-evidence-2025' },
              { tag: 'SME', title: 'How SMEs Can Reduce Compliance Costs by 90% with Blockchain', date: 'Dec 2024', href: '/blog/how-smes-can-reduce-compliance-costs-by-90-with-blockchain' },
              { tag: 'Infrastructure', title: 'Why We Built on AWS Singapore and Polygon', date: 'Nov 2024', href: '/blog/infrastructure-aws-polygon' },
            ].map((post, i) => (
              <Link key={i} href={post.href} className="group block bg-[#f8fafc] rounded-2xl p-6 border border-[#e2e8f0] hover:border-[#10b981] hover:shadow-md transition-all">
