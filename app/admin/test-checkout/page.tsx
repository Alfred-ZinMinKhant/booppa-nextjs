...
const SUBSCRIPTIONS: Sku[] = [
  ...
  { product_type: 'evaluate_suppliers_monthly', label: 'Evaluate Suppliers — monthly' },
  { product_type: 'verify_supplier_evidence_monthly', label: 'Verify Supplier Evidence — monthly' },
