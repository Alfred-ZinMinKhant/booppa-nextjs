            ...
            {[
              {
                ...
                desc: 'Provide your company name, website, and optional PDPA context. Takes under 2 minutes.',
              },
              {
                icon: CheckCircle,
                step: '2',
                title: 'AI generates structured evidence',
                desc: 'BOOPPA compiles compliance answers, scans your domain, and structures responses across the dimensions procurement officers evaluate.',
              },
              {
                icon: Shield,
                step: '3',
                title: 'Blockchain-anchored PDF delivered',
                desc: 'Your certificate is anchored on Polygon with a QR code buyers can scan to verify independently — no follow-up, no doubt.',
              },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="rounded-2xl border-2 border-[#10b981] bg-white p-8 relative">
              ...
              <div className="flex items-center gap-2 mb-1">
                ...
                <h3 className="text-xl font-bold text-[#0f172a]">RFP Kit Complete</h3>
              </div>
              <div className="text-3xl font-bold text-[#0f172a] mt-3 mb-1">SGD 599</div>
              <p className="text-sm text-[#64748b] mb-6">Per submission · Full 15-question dossier</p>
              <ul className="space-y-3 mb-8">
