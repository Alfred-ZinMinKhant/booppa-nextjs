						...
						<div className="space-y-8">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								...
								<div className="bg-[#0f172a] p-8 rounded-[2rem] border-2 border-[#10b981] shadow-2xl relative hover:-translate-y-1 transition-all">
									...
									<div className="flex items-start justify-between mb-4">
										...
										<span className="text-xs font-semibold px-2.5 py-1 rounded-full bg-[#10b981]/20 text-[#10b981]">
											Lifetime
										</span>
									</div>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
								<div className="bg-white p-7 rounded-[2rem] border border-[#e2e8f0] shadow-sm hover:-translate-y-1 hover:border-[#10b981] transition-all">
									...
									<Link
										href="/pdpa"
										className="block w-full text-center bg-[#10b981] hover:bg-[#059669] text-white font-semibold py-2.5 rounded-xl transition text-sm"
									>
										Start Scan
									</Link>
								</div>
								...
								<div className="bg-white p-7 rounded-[2rem] border border-[#e2e8f0] shadow-sm hover:-translate-y-1 hover:border-[#10b981] transition-all">
									...
									<p className="text-xs text-[#94a3b8] mb-5">
										Batch: 10 docs SGD 390 · 50 docs SGD 1,750
									</p>
									<Link
										href="/notarization"
										className="block w-full text-center border border-[#0f172a] text-[#0f172a] hover:bg-[#0f172a] hover:text-white font-semibold py-2.5 rounded-xl transition text-sm"
									>
										View Packages
									</Link>
								</div>
								...
								<div className="bg-white p-7 rounded-[2rem] border-2 border-violet-400 shadow-xl relative hover:-translate-y-1 transition-all">
									<div className="absolute top-[-12px] right-5 bg-violet-500 text-white px-3 py-0.5 rounded-full text-xs font-bold uppercase tracking-wide">
										GeBIZ Ready
									</div>
									<h3 className="text-lg font-bold mb-3 text-[#0f172a]">
										RFP Express
									...
									<ul className="space-y-2 mb-6">
										{[
											...
											>
												<span className="text-violet-500 font-bold flex-shrink-0">
													✓
												</span>
												{f}
											</li>
									...
									<Link
										...
										className="block w-full text-center bg-violet-600 hover:bg-violet-500 text-white font-semibold py-2.5 rounded-xl transition text-sm"
									>
										Get RFP Express
									</Link>
								</div>
								...
								<div className="bg-white p-7 rounded-[2rem] border-2 border-emerald-400 shadow-xl relative hover:-translate-y-1 transition-all">
									<div className="absolute top-[-12px] right-5 bg-emerald-500 text-white px-3 py-0.5 rounded-full text-xs font-bold uppercase tracking-wide">
										High-Value Bids
									</div>
									<h3 className="text-lg font-bold mb-3 text-[#0f172a]">
										RFP Complete
									...
									<p className="text-xs text-[#64748b] mb-5">
										Per RFP, full procurement dossier
									</p>
									<ul className="space-y-2 mb-6">
										{[
									...
									<Link
										href="/rfp-acceleration"
										className="block w-full text-center bg-emerald-600 hover:bg-emerald-500 text-white font-semibold py-2.5 rounded-xl transition text-sm"
									>
										Get RFP Complete
									</Link>
								</div>
							...
							<div className="bg-[#f8fafc] rounded-2xl border border-[#e2e8f0] p-6 flex flex-col sm:flex-row sm:items-center gap-4">
								<div className="flex-1">
									...
									<p className="text-sm text-[#64748b] mt-1">
										Enter a GeBIZ tender number. See your current win
										probability vs what you'd achieve with RFP Express or RFP
										Complete.
									</p>
								</div>
								<Link
									href="/tender-check"
									className="flex-shrink-0 px-5 py-2.5 bg-[#0f172a] text-white text-sm font-semibold rounded-xl hover:bg-[#1e293b] transition"
								>
									Try Free Calculator →
								</Link>
							</div>
					...
					{activeTab === "bundles" && (
						<div className="space-y-6">
							<p className="text-center text-[#64748b] max-w-2xl mx-auto">
								Bundles collapse multiple purchase decisions into one. Every
								bundle is a one-time payment. All components activate
							...
							<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
								...
								<div className="bg-white rounded-[2rem] border-2 border-[#10b981] shadow-xl overflow-hidden hover:-translate-y-1 transition-all">
									<div className="bg-[#10b981] px-7 py-5">
										...
										<p className="text-white/80 text-sm mt-1">
											Complete trust foundation in one purchase
										</p>
									</div>
									<div className="p-7">
								...
								<div className="bg-[#0f172a] rounded-[2rem] border-2 border-violet-400 shadow-2xl overflow-hidden hover:-translate-y-1 transition-all relative">
									...
									<div className="bg-violet-600 px-7 py-5">
										...
										<p className="text-white/80 text-sm mt-1">
											For vendors with an active tender right now
										</p>
									</div>
									<div className="p-7">
										<div className="flex items-end gap-3 mb-1">
								...
								<div className="bg-white rounded-[2rem] border-2 border-amber-400 shadow-xl overflow-hidden hover:-translate-y-1 transition-all">
									<div className="bg-amber-500 px-7 py-5">
										...
										<p className="text-white/90 text-sm mt-1">
											For contracts of SGD 100,000 or more
										</p>
									</div>
									<div className="p-7">
										<div className="flex items-end gap-3 mb-1">
