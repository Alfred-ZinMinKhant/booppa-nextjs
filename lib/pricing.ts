...
export const BUNDLE_PRODUCTS: Record<string, Product> = {
  vendor_trust_pack: {
    ...
    features: [
      ...
      'PDPA Quick Scan (SGD 299)',
      '2 Notarizations (SGD 138)',
      'Total standalone value: SGD 586',
      'Save SGD 237',
    ],
  },
  compliance_evidence_pack: {
    ...
    description: 'PDPA Quick Scan + a 7-document PDPA governance pack (DPMP, ROPA, Data Inventory, Vendor/DPA Register, Breach Runbook, Training, Security Review Log) + RFP Complete + blockchain-anchored Cover Sheet — documents grounded in a live scan of your site.',
    price: 799,
    currency: 'SGD',
    type: 'bundle',
    badge: '10-doc pack',
    features: [
      '7-document PDPA governance pack (DPMP, ROPA, Data Inventory, Vendor/DPA Register, Breach Runbook, Training, Security Review Log)',
      'PDPA Quick Scan included',
      'RFP Complete — 15 Q&A',
      'Documents grounded in a live website + PDPA scan',
      'Compliance Cover Sheet v3 (blockchain-anchored)',
...
export const SUBSCRIPTION_PRODUCTS: Record<string, Product> = {
  ...
  vendor_pro_monthly: {
    ...
    features: [
      ...
      'Quarterly PDPA Quick Scan with drift comparison',
  ...
  compliance_evidence_monthly: {
    ...
    description: 'Monthly refresh of your 7-document PDPA governance pack — plus PDPA + RFP coverage, blockchain-anchored cover sheets, and priority procurement support',
    price: 499,
    currency: 'SGD',
    type: 'subscription',
    features: [
      'Monthly 7-document PDPA governance pack refresh',
  ...
  pro_suite_monthly: {
    ...
    name: 'Pro Suite',
    description: 'Full enterprise evidence infrastructure — SSO, white-label reports, and a generous monthly notarization allowance',
    price: 4500,
    currency: 'SGD',
    type: 'subscription',
    badge: 'Most Popular',
